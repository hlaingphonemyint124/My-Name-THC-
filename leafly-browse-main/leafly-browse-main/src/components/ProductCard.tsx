...
export const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <Card className="overflow-hidden bg-gradient-card border-border hover:border-accent transition-all duration-300 hover:shadow-lg hover:shadow-accent/20">
      <div className="aspect-square overflow-hidden relative">
        ...
        <div className="absolute top-2 right-2 flex flex-col gap-2">
          ...
          {product.is_popular && (
            <Badge className="bg-gradient-gold text-accent-foreground shadow-lg flex items-center gap-1">
      ...
      <CardFooter className="flex gap-2">
        ...
        >
          <Button variant="outline" className="bg-[#00B900] hover:bg-[#00B900]/90 text-white border-[#00B900] hover:border-[#00B900]/90">
